...
public final class DaliliViewModel extends AndroidViewModel {
    ...
    */
    ...
    public final void addServiceProvider(String name, String phone, int categoryId, Integer subCategoryId, String imageUrl, String idCardUrl, boolean isPinned, boolean isRecommended, String priceCategory, String distanceCategory, final Function1<? super Boolean, Unit> onComplete) {
        Integer num;
        ...
        Integer num2 = num;
        int id3 = (num2 != null ? num2.intValue() : 0) + 1;
        ServiceProvider item = new ServiceProvider(Integer.valueOf(id3), name, phone, categoryId, subCategoryId, 0.0d, imageUrl == null ? "" : imageUrl, idCardUrl, true, isPinned, isRecommended, null, null, priceCategory == null ? "medium" : priceCategory, distanceCategory == null ? "near" : distanceCategory, new Date().toString());
    ...
    public final void addPendingProvider(String name, String phone, int categoryId, Integer subCategoryId, String imageUrl, String idCardUrl, String region, final Function1<? super Boolean, Unit> onComplete) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(phone, "phone");
        Intrinsics.checkNotNullParameter(onComplete, "onComplete");
        String docId = this.db.collection("pending_providers").document().getId();
        Intrinsics.checkNotNullExpressionValue(docId, "getId(...)");
        PendingProvider item = new PendingProvider(docId, name, phone, categoryId, subCategoryId, imageUrl == null ? "" : imageUrl, idCardUrl, "pending", region == null ? "" : region, new Date().toString());
    ...
    public static final void approvePendingProvider$lambda$35(DaliliViewModel this$0, PendingProvider $pending, final Function1 $onComplete, Task task) {
        Intrinsics.checkNotNullParameter(task, "task");
        if (task.isSuccessful()) {
            this$0.addServiceProvider($pending.getName(), $pending.getPhone(), $pending.getCategoryId(), $pending.getSubCategoryId(), $pending.getImageUrl(), $pending.getIdCardUrl(), false, false, "medium", "near", new Function1() { // from class: com.example.ui.DaliliViewModel$$ExternalSyntheticLambda3
